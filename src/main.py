...
def run_pcdnn_v2_experiments(dm, n_models_override=None, n_epochs_override=None, use_dependants=False,
                             use_dynamic_pred=False, debug_mode=False):
    '''
...
def run_model_experiments(dm, models=['PCDNN_V2'], **kwd_args):
    ...
    supported_models = {'PCDNN_V2': run_pcdnn_v2_experiments, 'SIMPLE_DNN': run_simple_dnn_experiments}
...
def main(debug_mode=False):
    ...
    '''
    run_model_experiments(dm, models='PCDNN_V2', n_models_override=5, n_epochs_override=200,
                          use_dependants=True, use_dynamic_pred=True, debug_mode=debug_mode)
