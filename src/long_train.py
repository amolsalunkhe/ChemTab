...
cfg = {'zmix': 'Y', 'ipscaler': None, 'opscaler': 'StandardScaler', 'noOfCpv': 25, 'loss': 'mse',
       'activation': 'selu', 'width': 10000, 'dropout_rate': 0.05, 
       ...
       'loss_weights': {'inv_prediction': 0.0, 'static_source_prediction': 1.0, 'dynamic_source_prediction': 1/3e5},
