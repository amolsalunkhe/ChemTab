...
cfg = {'ipscaler': 'StandardScaler', 'opscaler': 'StandardScaler', 'noOfCpv': 25, 'loss': 'R2_var_weighted',
       'activation': 'selu', 'width': 1000, 'dropout_rate': 0.05, 'zmix': 'Y', 
       ...
       'use_dependants': True}#, 'W_load_fn': '../datasets/Q_rot_MassR2.csv.gz'} 
