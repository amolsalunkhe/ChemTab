...
cfg = {'zmix': 'Y', 'ipscaler': None, 'opscaler': 'StandardScaler', 'noOfCpv': 15, 'loss': 'R2',
       ...
       'kernel_constraint': 'Y', 'kernel_regularizer': 'N', 'activity_regularizer': 'N', 'batch_size': 5000,
       'loss_weights': {'souener_prediction': 0.3, 'static_source_prediction': 5.0, 'dynamic_source_prediction': 1.0}}
